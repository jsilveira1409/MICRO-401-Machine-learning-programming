...
handles.Network = NeuralNetwork(handles.Layers, handles.Sigmas);
handles.Network.initialize(handles.initialize)
...
switch handles.Sigmas{end}
    ...
    case 'softmax'
        ...
        handles.Ytrain = one_hot_encoding(handles.Ytrain);
        handles.Ytest = one_hot_encoding(handles.Ytest);
end
